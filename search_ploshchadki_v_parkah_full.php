...
<header>
    ...
    <div class = "info_up head_title" style= "position: fixed; left: 31%;top:14%;">Поиск адреса игровой площадки в парке</div>
...
<div class = "div_history_bd" style= "position: absolute; left: 8%;top:30%; width: 80%; border:none;">
    <table style= "position: absolute; left: 0%;top:50%;">
        ...
        if (isset($_POST['SurfaceTypeWinter']) || isset($_POST['DisabilityFriendly']) || isset($_POST['Lighting'])){
            ...
            $products = mysqli_query($mysql, "SELECT * FROM `ploshchadki_v_parkah_full` WHERE SurfaceTypeWinter LIKE '%$select%' 
