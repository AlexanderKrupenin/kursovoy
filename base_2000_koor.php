...
<body>
<div class = "div_history_bd" style="position:absolute; border:none; top: 25%; left: 25%;">';
        echo '<table><tr>
	        <th>adress</th>
            <th>latitude</th>
            <th>longitude</th>
        ...
        echo'<form method=POST action = "http://kursovoy:3006/main.php?id='.$id.'">
            ...
            <footer>
            <div class = "top_line head_title"  style= "position: absolute; left: 0%; top:10780%; width: 100%; height: 20%;">
